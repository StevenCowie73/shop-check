...
<script>${SCRIPT.replace('__COLOUR__', JSON.stringify(STATUS_COLOUR)).replace('__DEFAULT_MAP_AREA__', JSON.stringify(DEFAULT_MAP_AREA)).replace('__MAPS_JS__', MAPS_JS)}</script>
</body>
</html>`;
}
